...
*/
$config['tables']['users']           = 'lu_users';
$config['tables']['groups']          = 'lu_groups';
$config['tables']['users_groups']    = 'lu_users_groups';
$config['tables']['login_attempts']  = 'lu_login_attempts';
 ...
 */
$config['site_title']                 = "Epayco";       // Site Title, example.com
